...
final class GroupNewGameCommandProcessorTest extends ProcessorTestCase
{
    ...
    private const int EPHEMERAL_MESSAGE_ID = 251718676; // ephemeralGroupMessagePayload default
    ...
    public function testDeletesTheEphemeralCommandAfterSendingThePicker(): void
    {
        $update = TelegramUpdate::fromArray(
            $this->ephemeralGroupMessagePayload(text: '/new_game@' . BOT_USERNAME),
        );
        ...
        $this->assertSame(self::EPHEMERAL_SENDER_ID, $deleteParams['receiver_user_id']);
    }
}
