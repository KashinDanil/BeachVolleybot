...
namespace BeachVolleybot\Tests\Integration\Queue;
...
final class FileQueueTest extends TestCase
{
    ...
    {
        $this->dir = sys_get_temp_dir() . '/bvb_queue_test_' . uniqid(more_entropy: true);
    ...
    {
        $queue = new FileQueue('missing', sys_get_temp_dir() . '/bvb_nonexistent_' . uniqid(more_entropy: true));
