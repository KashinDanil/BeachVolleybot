...
final class HelpMessageBuilder extends AbstractMessageBuilder
{
    ...
    public function build(string $botUsername): TelegramMessage
    {
        return $this->buildMessage($this->buildText($botUsername), []);
    }

    private function buildText(string $botUsername): string
    {
        ...
        return $this->renderParagraph(sprintf($this->translator->translate(self::CREATE_PARAGRAPH), $botUsername))
            ...
            . $blank
            . $this->renderParagraph($this->translator->translate(self::GAMES_LIST_PARAGRAPH));
    }
